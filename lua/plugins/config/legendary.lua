...
legendary.setup({
  keymaps = {
    ...
    -- { '<C-h>', '<ESC> :wincmd h<CR>', description = 'Window: focus left', mode = modes('nivxt') },
    -- { '<C-j>', '<ESC> :wincmd j<CR>', description = 'Window: focus down', mode = modes('nivxt') },
    -- { '<C-k>', '<ESC> :wincmd k<CR>', description = 'Window: focus up', mode = modes('nivxt') },
    -- { '<C-l>', '<ESC> :wincmd l<CR>', description = 'Window: focus right', mode = modes('nivxt') },
